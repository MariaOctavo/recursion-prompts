...
var factorial = function(n) {
  // if the given number equals zero
  if (n === 0) {
    /* return 1  because you cant return 0 because 0 * anything will always be 0*/
    return 1;
  // If the number is less than 0, return null
} else if (n < 0) {
  return null;
}
  // return the product factorial
